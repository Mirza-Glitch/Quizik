...
export default function ModalCreateLater() {
  ...
  return (
    <ModalBase>
      ...
      <p className="mb-2">
        It appears that you have recently created a quiz {timeSince(lastDay)}.
        Our platform permits users to create one quiz per 24-hour period for
        fairness and optimization purposes. Therefore, you will be able to
        create your next quiz {timeSince(newDay)}. We encourage you to return
        after this time has elapsed and create another engaging quiz!
      </p>
